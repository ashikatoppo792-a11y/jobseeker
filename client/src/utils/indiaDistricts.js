export const STATE_DISTRICT_DATA = {
  "Andhra Pradesh": [
    ...
    "Chittoor", "East Godavari", "Eluru", "Guntur", "Kakinada", "NTR (Vijayawada)",
  ...
  "Arunachal Pradesh": [
    ...
    "Lower Subansiri", "Namsai", "Pakke Kessang", "Papum Pare (Itanagar)", "Shi Yomi",
    "Siang", "Tawang", "Tirap", "Upper Siang", "Upper Subansiri", "West Kameng", "West Siang"
  ],
  "Assam": [
    "Baksa", "Barpeta", "Bongaigaon", "Cachar (Silchar)", "Charaideo", "Chirang",
    "Darrang", "Dhemaji", "Dhubri", "Dibrugarh", "Dima Hasao", "Goalpara", "Golaghat",
    "Hailakandi", "Hojai", "Jorhat", "Kamrup", "Kamrup Metropolitan (Guwahati)",
    "Karbi Anglong", "Karimganj", "Kokrajhar", "Lakhimpur", "Majuli", "Morigaon",
    "Nagaon", "Nalbari", "Sivasagar", "Sonitpur", "Tinsukia", "Udalguri", "West Karbi Anglong"
  ],
  "Bihar": [
  ...
  "Chhattisgarh": [
    ...
    "Bilaspur", "Dantewada", "Dhamtari", "Durg (Bhilai)", "Gariaband",
    "Gaurela-Pendra-Marwahi", "Janjgir-Champa", "Jashpur", "Kabirdham (Kawardha)",
    "Kanker", "Khairagarh", "Kondagaon", "Korba", "Koriya", "Mahasamund", "Mungeli",
    "Narayanpur", "Raigarh", "Raipur", "Rajnandgaon", "Sukma", "Surajpur", "Surguja"
  ],
  "Delhi NCR": [
    "Central Delhi", "East Delhi", "New Delhi", "North Delhi", "North East Delhi",
    "North West Delhi", "Shahdara", "South Delhi", "South East Delhi", "South West Delhi",
    "West Delhi", "Gurugram", "Noida", "Ghaziabad", "Faridabad"
  ],
  "Goa": [
  ...
  "Gujarat": [
    ...
    "Gir Somnath", "Jamnagar", "Junagadh", "Kheda", "Kutch (Bhuj)", "Mahisagar",
  ...
  "Odisha": [
    ...
    "Kandhamal", "Kendrapara", "Keonjhar (Kendujhar)", "Khordha (Bhubaneswar HQ)", "Koraput",
    "Malkangiri", "Mayurbhanj (Baripada)", "Nabarangpur", "Nayagarh", "Nuapada",
    "Puri", "Rayagada", "Sambalpur", "Subarnapur (Sonepur)", "Sundargarh (Rourkela HQ)"
  ],
  "Puducherry": [
  ...
  "Punjab": [
    ...
    "SAS Nagar (Mohali)", "Sangrur", "SBS Nagar (Nawanshahr)", "Sri Muktsar Sahib",
    "Tarn Taran"
  ],
  "Rajasthan": [
    "Ajmer", "Alwar", "Anupgarh", "Balotra", "Banswara", "Baran", "Barmer", "Beawar",
    "Bharatpur", "Bhilwara", "Bikaner", "Bundi", "Chittorgarh", "Churu", "Dausa",
    "Deeg", "Dholpur", "Didwana-Kuchaman", "Dungarpur", "Ganganagar", "Gangapur City",
    "Hanumangarh", "Jaipur City", "Jaipur Rural", "Jaisalmer", "Jalore", "Jhalawar",
    "Jhunjhunu", "Jodhpur City", "Jodhpur Rural", "Karauli", "Kekri", "Kota",
    "Kotputli-Behror", "Khairthal-Tijara", "Nagaur", "Neem Ka Thana", "Pali", "Phalodi",
  ...
  "West Bengal": [
    ...
    "Murshidabad", "Nadia", "North 24 Parganas", "Paschim Bardhaman (Durgapur)",
...
export const ALL_INDIAN_STATES = [
  "All States & UTs",
  "Pan India (Remote)",
  ...Object.keys(STATE_DISTRICT_DATA)
];
